...
function staticPortfolioCard(p){var tags=(p.tags||[]).join(' ');return '<a class="portfolio-card" href="portfolio.html#'+encodeURIComponent(p.slug)+'"><div class="portfolio-photo"><img src="'+esc(p.coverImage)+'" alt="'+esc(p.title)+'" loading="lazy" style="object-position:'+esc(p.coverPosition||'center center')+'"></div><div class="portfolio-body"><div class="portfolio-title">'+esc(p.title)+'</div><div class="portfolio-kind">'+esc(p.kind)+'</div><div class="portfolio-tags">'+esc(tags)+'</div><span class="card-arrow">→</span></div></a>';}
...
function portfolioCard(p){var meta=[p.location,p.areaPyeong?p.areaPyeong+'평':''].filter(Boolean).join(' ');var tags=[p.style?'#'+p.style.replace(/\s+/g,''):'','#DAHAM'].filter(Boolean).join(' ');var image=p.coverImageUrl?'<img src="'+esc(p.coverImageUrl)+'" alt="'+esc(p.title)+'" loading="lazy">':'';return '<a class="portfolio-card" href="portfolio.html#'+encodeURIComponent(p.slug)+'"><div class="portfolio-photo">'+image+'</div><div class="portfolio-body"><div class="portfolio-title">'+esc(p.title||'DAHAM PROJECT')+'</div><div class="portfolio-kind">'+esc(meta||'전체 인테리어')+'</div><div class="portfolio-tags">'+esc(tags)+'</div><span class="card-arrow">→</span></div></a>';}
