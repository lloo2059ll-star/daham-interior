...
function staticPortfolioCard(p){var tags=(p.tags||[]).join(' ');return '<a class="portfolio-card" href="portfolio.html#'+encodeURIComponent(p.slug)+'"><div class="portfolio-photo"><img src="'+esc(p.coverImage)+'" alt="'+esc(p.title)+'" loading="lazy"></div><div class="portfolio-body"><div class="portfolio-title">'+esc(p.title)+'</div><div class="portfolio-kind">'+esc(p.kind)+'</div><div class="portfolio-tags">'+esc(tags)+'</div><span class="card-arrow">→</span></div></a>';}
