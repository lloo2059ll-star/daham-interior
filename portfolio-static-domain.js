(function(root,factory){
  ...
  var PROJECTS=[
    ...
    project({slug:'bonggok-hyunjin-36',title:'봉곡 현진에버빌 36평',location:'구미 봉곡',area:'36평',kind:'아파트 전체 인테리어',tags:['#아파트','#36평','#전체인테리어'],photos:['living-main','living-kitchen','kitchen','bathroom-main','bathroom-secondary','entry','bedroom','room-storage','hallway','bathroom-detail']}),
