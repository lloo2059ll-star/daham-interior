...
test('viewer exposes integrity, journal navigation, preview and search landmarks',()=>{['보관 완료','무결성 확인 완료','현장일지 PDF','일지 내용 또는 공종 검색','archive-viewer','archive-integrity','archive-folders','archive-paper','archive-head-actions'].forEach(x=>assert.match(html,new RegExp(x)));});
