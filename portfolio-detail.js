...
root.innerHTML='<article class="detail shell"><a class="detail-back" href="portfolio.html">← 포트폴리오</a><header class="detail-head"><p class="detail-kicker">DAHAM PROJECT</p><h1>'+esc(row.title)+'</h1><p class="detail-meta">'+esc([row.location,row.area,row.kind].filter(Boolean).join(' · '))+'</p><p class="detail-summary">'+esc(desc)+'</p></header><div class="detail-rule"></div><section class="detail-section"><h2>현장 소개</h2><p>기존 공간의 불편한 동선과 수납을 확인한 뒤, 가족의 생활 방식에 맞춰 필요한 부분을 우선 정리했습니다. 사진과 함께 시공 결과를 확인해보세요.</p></section><section class="detail-gallery" aria-label="시공 사진">'+row.photos.map(function(photo,i){return '<figure><img src="'+esc(photo)+'" alt="'+esc(row.title)+' 시공 사진 '+(i+1)+'" loading="lazy"><figcaption>'+esc(i<2?'완공 사진':'공간별 시공 사진')+'</figcaption></figure>';}).join('')+'</section><section class="detail-cta"><h2>비슷한 현장 상담이 필요하신가요?</h2><p>구미·김천·대구 인테리어 상담부터 현장 실측, 시공 후 A/S까지 직접 안내드립니다.</p><a href="./#footer">견적 문의하기</a></section></article>';
})();
