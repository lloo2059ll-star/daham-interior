...
var descriptions=spaces[row.slug]||[], before=row.slug==='geochang-prugio-34'?'<section class="detail-section"><h2>BEFORE · 공사 전</h2><div class="detail-space-gallery">'+['before-01.jpg','before-02.jpg','before-03.jpg','before-04.jpg','before-05.jpg'].map(function(photo){return '<figure><img src="portfolio-assets/projects/geochang-prugio-34/'+photo+'" alt="거창 푸르지오 34평 공사 전 사진" loading="lazy"><figcaption>BEFORE · 공사 전 사진</figcaption></figure>';}).join('')+'</div><p>기존 공간의 구조와 마감 상태를 확인한 뒤 주방 동선과 수납 계획을 우선 정리했습니다.</p></section>':'';
